...
local startpos = self.Position
	...
	render.DrawSprite(startpos, 400*self.GSize,90*self.GSize,Color(200, math.random(200,200), math.random(230,255),self.GAlpha))
	render.DrawSprite(startpos, 70*self.GSize,280*self.GSize,Color(200, math.random(200,200), math.random(240,255),0.7*self.GAlpha))
	--shockwave
