...
list.Add( "sc_armor_hardener_admin_Types", "[Concord] Armor Enhancer" )
list.Add( "sc_armor_hardener_admin_Types", "[Jove] Armor Enhancer" )
list.Add( "sc_armor_hardener_admin_Types", "[Polaris] Armor Enhancer" )
...
function TOOL.BuildCPanel(CPanel)
	...
	local AOptions = list.Get( "sc_armor_hardener_admin_Types" )
	...
	for k, v in pairs( AOptions ) do
		ARealOptions[ v ] = { sc_armor_hardener_sc_armor_hardener = v }
	end
	
	CPanel:AddControl( "ListBox", { Label = "Armor Upgrades", Height = "300", Options = RealOptions} )
	CPanel:AddControl( "ListBox", { Label = "Advanced Upgrades", Height = "80", Options = ARealOptions} )
end
